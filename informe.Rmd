...
pielabel = c("Municipal", "Otros", "Particular Subvencionado", "Particular Pagado")
...
```{r}
cor(datos$PROM_GRAL, datos$ASISTENCIA)
```
Finalmente, se puede estudiar si hay una relación directa entre el porcentaje de asistencia y el promedio final. Al calcular la correlación el coeficiente obtendio es de 0.4; no hay relación observable.
